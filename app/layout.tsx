...
export const metadata = {
  title: 'Portfolio Website | Ankit jain',
  description: 'Ankit jain portfolio website',
}
...
export default function RootLayout({
  ...
  return (
    ...
    <html lang="en" className='!scroll-smooth'>
      ...
      bg-grey-50 text-gray-950 relative  pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}>
        ...
        xl:left-[-28rem] 2xl:left-[-5rem] dark:bg-[#676394]'></div>
