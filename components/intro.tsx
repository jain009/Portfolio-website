    ...
    '>
        <div className='flex items-center justufy-center '>
            <div className='relative'>
                ...
                <motion.span className="absolute bottom-0 
                right-0 text-4xl"
                initial= {{opacity:0, scale: 0}}
                animate= {{opacity:1, scale:1}}
                transition={{
        ...
        >
            <span className='font-bond'>Hello. I'm Ankit Jain </span> I'm a {" "}
            <span className='font-bold'>full-stack devloper</span> with{" "}
            <span font-bold> 1 years</span> of experience. I enjoy
        ...
        justify-center gap-2 px-4 text-lg font-medium"
            ...
            py-3 flex items-cneter gap-2
            rounded-full outline-none
            focus:scale-110 hover:bg-gray-950 active:scale-105
            transition"
            onClick={() =>{
            ...
            hover:text-gray-950 
             ...
             border-black/10 dark:text-white/60'
             href="https://linkedin.com/in/ankitjain009"
              target="_blank"
                 >
                <BsLinkedin />
            </a>
            <a className='bg-white p-4 tetx-gray-700
            flex items-center gap-2 text-[1.35rem]
            focus:scale-1.15  rounded-full
            hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border
             border-black/10  dark:text-white/60' 
              href="https://github.com/jain009 "
               target="_blank"
        ><FaGithubSquare/></a>
        </motion.div>
