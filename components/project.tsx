...
export default function Project({ title, description, tags, imageUrl, }: 
  ...
  style = {{  
    ...
    <section 
  className='gorup bg-gray-100 max-w-[42rem] border border-black/5
overflow-hidden rounded-lg  sm:pr-8 relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0
 even:pl-8 hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20'>
    <div className='pt-4 px-5 pb-7 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full group-even:ml-[18rem]
    '>
  <h3 className='text-2xl font-semibond '>{ title }</h3>
  ...
  className="absolute top-8 -right-40 w-[28.25rem] rounded-t-lg
      ...
      gruop-hover:-translate-x-3
      group-hover:translate-y-3 
      group-hover:-rotate-2

      gruop-even:hover:translate-x-3
